...
<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('staff.books.store') }}" class="space-y-4" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" rows="4" class="w-full border border-gray-300 px-3 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description') }}</textarea>
                @error('description')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="flex gap-2 pt-4">
                ...
                <a href="{{ route('staff.libraries.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg transition font-medium">
                    Batal
                </a>
            </div>
        </form>
