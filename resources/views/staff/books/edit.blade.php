...
<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('staff.books.update', $book) }}" class="space-y-4" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="flex gap-3 pt-4">
                ...
                <a href="{{ route('staff.books.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg transition font-medium">
                    Batal
                </a>
            </div>
        </form>
