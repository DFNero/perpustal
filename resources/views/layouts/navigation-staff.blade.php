<div x-data="{ sidebarOpen: window.innerWidth > 1024 }" 
    ...
    >
        ...
        <div class="flex items-center h-16 border-b border-gray-700 shrink-0" :class="sidebarOpen ? 'justify-between px-6' : 'justify-center'">
            <a x-show="sidebarOpen" href="{{ route('staff.dashboard') }}" class="font-bold text-xl text-white tracking-wide flex items-center gap-2">
                <span class="text-orange-500">👔</span> Staff Panel
            </a>
            <a x-show="!sidebarOpen" href="{{ route('staff.dashboard') }}" class="text-orange-500 text-2xl">👔</a>
